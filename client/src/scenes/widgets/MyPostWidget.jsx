      ...
      {isImage && (
        ...
        >
          <Dropzone
            ...
            multiple={false}
            onDrop={
              (acceptedFiles) => setImage(acceptedFiles[0]) //dropzone is a third party app, so we need to set this field's value manually, UNLKE the inputs before this one that are programmed with react.
            }
          >
